      ...
      <React.Fragment>
        ...
        <section>
          ...
          <section className="inline">
            <ReactTextTransition
              text={`${this.state.number}`.split("")[0]}
              className="big"
              inline
            />
            <ReactTextTransition
              text={`${this.state.number}`.split("")[1]}
              className="big"
              inline
            />
            <span className="big">.</span>
            <ReactTextTransition
              text={`${this.state.number}`.split("")[2]}
              inline
            />
            <ReactTextTransition
              text={`${this.state.number}`.split("")[3]}
              inline
            />
            <ReactTextTransition
              text={`${this.state.number}`.split("")[4]}
              inline
            />
          </section>
          <section className="inline">
